...
Page(Object.assign({}, Zan.Dialog, Zan.Toast, {
  data: {
    ...
    4、办理本卡需出示本人身份证及一百元储物柜押金，押金可于退卡时退还。
    5、本卡不可转让、转借，具体使用规则以现场公告或微信公众号公告为准。
    ...
    5、本卡不可转让、转借，具体使用规则以现场公告或微信公众号公告为准。
    6、本卡最终解释权归福建省康健体育文化发展有限公司所有。
    7、客服热线：0591-83775953
    `,
      6: `
    1、此卡已含十次门票，限本人使用，不可转借或转让，遗失可补卡（补卡工本费20元），报名后未开卡可全额退款；开课2节内按实际上课次数计算，并扣除15%违约金后可退回余款；开课后2节后不予退款；学员开课后应在20天内完成培训。儿童培训卡原价850元10节课每次课程1.5小时，任选一种泳姿。
